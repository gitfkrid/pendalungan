    ...
    @section('content')
        <div class="row">
            <div class="col-lg-12 mb-3">
                <a href="javascript:void(0)" class="btn btn-primary" onclick="addForm()"><i class="fa fa-plus-circle"></i> Tambah Level</a>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
        ...
        <script type="text/javascript">
            ...
            $(function(){
                ...
                $('#modal-form form').on('submit', function(e){
                    if(!e.isDefaultPrevented()){
                        var id = $('#id').val();
                        if(save_method == "add") url = "{{ route('level.store') }}";
                        else url = "level/"+id;
            ...
            function deleteData(id) {
                Swal.fire({
                    ...
                    text: "Data level users akan dihapus!",
                    icon: 'warning',
