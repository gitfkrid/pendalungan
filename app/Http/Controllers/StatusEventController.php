    ...
    public function dataStatusEvent() {
        if(Auth::user()->id_level == '1') {
            ...
            foreach($status_event as $list) {
                ...
                $row[] = '<a href="javascript:void(0)" class="btn btn-warning btn-sm" onclick="editForm('.$list->id_status_event.')"><i class="fas fa-pencil-alt"></i></a> 
                        <a href="javascript:void(0)" class="btn btn-danger btn-sm" onclick="deleteData('.$list->id_status_event.')"><i class="fa fa-trash"></i></a>';
                $data[] = $row;
            }
